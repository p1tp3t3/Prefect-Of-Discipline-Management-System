    ...
    <div class="form-container">
        ...
        <div class="form-section">
            ...
            <div class="info-group">
                ...
                <span class="info-value">{{ $complainant_name }}</span>
            </div>
            <div class="info-group">
                <span class="info-label">Type:</span>
                <span class="info-value">{{ $complainant_user_type }}</span>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="info-group">
                ...
                <span class="info-value">{{ $incident ?? 'N/A' }}</span>
            </div>
            <div class="info-group">
                <span class="info-label">Summary:</span>
                <span class="info-value">{{ $incident_summary ?? 'N/A' }}</span>
            </div>
            <div class="info-group">
